...
namespace DentedPixel.LTExamples
{
    ...
    public class TestingUnitTests : MonoBehaviour
    {
        ...
        private int lt1Id;
        private readonly LTDescr lt2;
        private readonly LTDescr lt3;
        private LTDescr lt4;
        ...
        private void Start()
        {
            ...
            Vector3 cubeDestEnd = new(100f, 20f, 0f);
        ...
        private IEnumerator timeBasedTesting()
        {
            ...
            LTBezierPath roundCircPath = new(roundCirc);
            ...
            for (int i = 0; i < groupTweens.Length; i++)
            {
                ...
                Dictionary<string, object> finalDict = new() { { "final", finalPos }, { "go", groupGOs[i] } };
