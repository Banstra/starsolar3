...
public class PathSplineEndless : MonoBehaviour
{
    ...
    private readonly List<Vector3> trackPts = new();
    private int zIter = 0;
    ...
    private void addRandomTrackPoint()
    {
        ...
        Vector3 randomInFrontPosition = new((randX - 0.5f) * 20f, 0f, zIter * 40f);
    ...
    {
        AnimationCurve volumeCurve = new(new Keyframe(0f, 0.005464481f, 1.83897f, 0f), new Keyframe(0.1114856f, 2.281785f, 0f, 0f), new Keyframe(0.2482903f, 2.271654f, 0f, 0f), new Keyframe(0.3f, 0.01670286f, 0f, 0f));
        AnimationCurve frequencyCurve = new(new Keyframe(0f, 0.00136725f, 0f, 0f), new Keyframe(0.1482391f, 0.005405405f, 0f, 0f), new Keyframe(0.2650336f, 0.002480127f, 0f, 0f));
